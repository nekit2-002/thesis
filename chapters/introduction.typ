...
версий строк. В PostgreSQL для решения этой задачи используется фоновый процесс очистки, называющийся vacuum @vac1
@vac2. При его неразумном использовании (а также и по причине "распухания" таблиц),
